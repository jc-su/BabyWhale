...
(MIT) educational system built on a $\sim$14.5K-line DeepSeek-style stack (MLA,
MoE with auxiliary-loss-free balancing, multi-token prediction, speculative
decoding, paged KV, continuous batching) that runs on a laptop via MLX. A
...
$\sim$2.5 minutes on an Apple-Silicon laptop, and 334 tests---including the
