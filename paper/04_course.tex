...
\begin{figure}[t]
  \centering
  \input{figures/fig_guards}
  \caption{\textbf{Machine-checked courseware.} Three artifact types are each
  bound to the maintained implementation by a guard---exercises by behavioral
  equivalence (G1), displayed code by symbol existence (G2), quantitative
  claims by regeneration scripts (G3)---and continuous integration fails when
  any binding breaks.}
  \label{fig:guards}
\end{figure}
